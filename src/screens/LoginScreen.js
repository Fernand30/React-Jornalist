...
export default class LoginScreen extends Component {
  ...
  loginWithCredentials(email, pass) {
    ...
    Auth
      .signInWithCredentials(email, pass)
      .then(this.toggleCredentialsLoading)
      .catch(error => {
        this.handleLoginError(error)
        this.toggleCredentialsLoading()
      })
      ...
      <ImageBackground source={require('../../assets/Images_Icons/bg.png')} style={styles.container}>
        ...
        <Animated.View                 // Special animatable View
          ...
          <ScrollView contentContainerStyle={styles.scrollView}>
            ...
            <Touchable onPress={this.onPressSignInPhoneNumber}>
              <Text style={styles.buttonSignUpLabel}>{I18n.t('loginScreen.signInPhone')}</Text>
            </Touchable>
